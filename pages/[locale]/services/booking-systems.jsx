...
const RELEVANT_KEYS = ['drivesoft-backoffice', 'sti-web', 'sti-mobile', 'bozic-konig']
  ...
  return (
    <>
      <SEO
        ...
        url={`${SITE_URL}/${currentLocale}/services/booking-systems`}
        locale={ogLocale}
      ...
      <main className="pt-20">
        ...
        <section className="grain bg-ink-900 border-b border-line py-16 sm:py-24">
          <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="callsign">BKG — Service</span>
            </div>
        ...
        <section className="grain bg-ink-900 border-b border-line py-16 sm:py-20">
          <div className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <h2 className="font-display font-bold text-paper text-2xl mb-8">{t('flowTitle')}</h2>
              ...
              {flow.map((item, i) => (
                <div key={i} className="bg-ink-800 p-5">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-display font-semibold text-paper text-sm">{item.step}</h3>
                  </div>
