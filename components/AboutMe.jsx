        ...
        <div className="mt-12 grid lg:grid-cols-2 gap-6">
          ...
          >
            ...
            <dl className="mt-8 grid grid-cols-2 gap-3">
              {stats.map((s) => (
                <div key={s} className="rounded-xl bg-ink-850 p-4">
                  <dd className="font-display text-xl font-bold text-paper">{t(`stats.${s}.value`)}</dd>
          ...
          <motion.div
            ...
            className="panel rounded-2xl p-6 sm:p-8 flex flex-col"
          >
